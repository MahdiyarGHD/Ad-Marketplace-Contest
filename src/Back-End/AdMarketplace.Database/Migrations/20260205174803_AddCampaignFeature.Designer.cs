...
namespace AdMarketplace.Database.Migrations
{
    ...
    [Migration("20260205174803_AddCampaignFeature")]
    partial class AddCampaignFeature
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("AdMarketplace.Domain.Contracts.Common.CampaignCreativeContract", "CreativeJson", b1 =>
                        {
                            ...
                            b1.PrimitiveCollection<string>("LinkUrls");

                            b1.PrimitiveCollection<string>("MediaUrls");
