...
namespace AdMarketplace.Database.Migrations
{
    ...
    [Migration("20260215202819_ChangeBalanceDefaultValue")]
    partial class ChangeBalanceDefaultValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdMarketplace.Database.Models.Channel", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastReadinessCheckAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("AdMarketplace.Database.Models.Deal", b =>
                {
                    ...
                    b.Property<string>("PostedTextHash")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("AdMarketplace.Database.Models.UserTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserTransactions", "AdMarketplace");
                });
