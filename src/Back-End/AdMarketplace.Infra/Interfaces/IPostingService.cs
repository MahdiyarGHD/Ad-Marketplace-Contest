...
public interface IPostingService
{
    ...
    Task<ErrorOr<int>> GetPostViewCountAsync(Guid agentId, string channelUsername, long messageId, CancellationToken ct = default);
    Task<ErrorOr<bool>> DeletePostAsync(long channelChatId, long messageId, CancellationToken ct = default);
}

public record PostVerificationResult(bool Exists, bool WasEdited, int ViewCount);
